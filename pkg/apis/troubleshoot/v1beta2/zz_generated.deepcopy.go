...
func (in *Collect) DeepCopyInto(out *Collect) {
	*out = *in
	...
	if in.PrivilegedHostExec != nil {
		in, out := &in.PrivilegedHostExec, &out.PrivilegedHostExec
		*out = new(PrivilegedHostExec)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrivilegedHostExec) DeepCopyInto(out *PrivilegedHostExec) {
	*out = *in
	out.CollectorMeta = in.CollectorMeta
	if in.ImagePullSecret != nil {
		in, out := &in.ImagePullSecret, &out.ImagePullSecret
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrivilegedHostExec.
func (in *PrivilegedHostExec) DeepCopy() *PrivilegedHostExec {
	if in == nil {
		return nil
	}
	out := new(PrivilegedHostExec)
