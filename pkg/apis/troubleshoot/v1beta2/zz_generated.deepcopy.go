...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AllLogs) DeepCopyInto(out *AllLogs) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllLogs.
func (in *AllLogs) DeepCopy() *AllLogs {
	if in == nil {
		return nil
	}
	out := new(AllLogs)
...
func (in *Collect) DeepCopyInto(out *Collect) {
	*out = *in
	...
	if in.ExecCopyFromHost != nil {
		in, out := &in.ExecCopyFromHost, &out.ExecCopyFromHost
		*out = new(ExecCopyFromHost)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExecCopyFromHost) DeepCopyInto(out *ExecCopyFromHost) {
	*out = *in
	out.CollectorMeta = in.CollectorMeta
	if in.ImagePullSecret != nil {
		in, out := &in.ImagePullSecret, &out.ImagePullSecret
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExecCopyFromHost.
func (in *ExecCopyFromHost) DeepCopy() *ExecCopyFromHost {
	if in == nil {
		return nil
	}
	out := new(ExecCopyFromHost)
...
func (in *HostAnalyze) DeepCopyInto(out *HostAnalyze) {
	*out = *in
	...
	if in.UDPPortStatus != nil {
		in, out := &in.UDPPortStatus, &out.UDPPortStatus
		*out = new(UDPPortStatusAnalyze)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
	...
	if in.SubnetAvailable != nil {
		in, out := &in.SubnetAvailable, &out.SubnetAvailable
...
func (in *HostCollect) DeepCopyInto(out *HostCollect) {
	*out = *in
	...
	if in.HostCopy != nil {
		in, out := &in.HostCopy, &out.HostCopy
		*out = new(HostCopy)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *RemoteSubnetAvailable) DeepCopy() *RemoteSubnetAvailable {
	if in == nil {
		return nil
	}
	out := new(RemoteSubnetAvailable)
...
func (in *SubnetAvailableAnalyze) DeepCopy() *SubnetAvailableAnalyze {
	if in == nil {
		return nil
	}
	out := new(SubnetAvailableAnalyze)
...
func (in *UDPPortStatusAnalyze) DeepCopy() *UDPPortStatusAnalyze {
	if in == nil {
		return nil
	}
	out := new(UDPPortStatusAnalyze)
